...
public class PlayerServiceImplTest {
    ...
    @Test
    public void testRegisterPlayerWhenValidLoginAndPasswordThenPlayerRegistered() throws LoginExistsException {
    ...
    @Test
    public void testRegisterPlayerWhenExistingLoginThenLoginExistsException() {
        String login = "testLogin";
        String password = "testPassword";
    ...
    @Test
    public void testAddActionToHistoryWhenValidPlayerIdAndActionThenActionAddedToHistory() {
        Long playerId = 1L;
