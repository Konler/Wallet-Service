...
public class WalletServiceImplTest {
    ...
    @Test
    public void testActivateTransactionWhenTransactionIsSuccessfulThenReturnTrue() throws ImpossibleTransactionException {
        Long id = 1L;
        ...
        when(transactionRepository.createTransaction(id, type, amount, playerId)).thenReturn(transaction);

        boolean result = walletService.activateTransaction(id, type, amount, playerId);
