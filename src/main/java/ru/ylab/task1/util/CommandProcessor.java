...
public class CommandProcessor {
    ...
    public void processChangeBalanceCommand(TransactionType transactionType, Long playerId) {
        outputHandler.displayMessage("Введите id транзакции:");
        String transactionId = inputHandler.getUserInput();
        ...
        try {
            ...
            done = wallerService.activateTransaction(id, transactionType, amount, playerId);
